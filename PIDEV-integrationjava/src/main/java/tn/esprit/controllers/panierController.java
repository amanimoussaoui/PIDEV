...
public class panierController {
    ...
    private HBox createCartItemBox(Panier panier) {
        ...
        Label priceLabel = new Label("Prix unitaire: " + String.format("%.2f DT", panier.getProduct().getPrix()));
        priceLabel.setStyle("-fx-font-size: 14px; -fx-text-fill: #555555;");
        Label totalLabel = new Label("Total: " + String.format("%.2f DT", panier.getTotale()));
    ...
    private void updateTotal() {
        ...
        totalLabel.setText("Total: " + df.format(total) + " DT");
    }
    ...
    private void proceedToPayment() {
        ...
        // For now, just show a confirmation (you can implement payment logic later)
        showAlert("Succès", "Paiement simulé ! Commande confirmée.");
        // Optionally, you can clear the cart by deleting from the database
        try {
            returnToMarket();
        } catch (IOException e) {
            e.printStackTrace();
