 ...
 */
final class Version20250304220210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidature (id INT AUTO_INCREMENT NOT NULL, id_terrain_id INT DEFAULT NULL, utilisateur_id INT DEFAULT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, but VARCHAR(255) NOT NULL, montant DOUBLE PRECISION NOT NULL, etat VARCHAR(255) NOT NULL, recommandation LONGTEXT DEFAULT NULL, INDEX IDX_E33BD3B82FA70B96 (id_terrain_id), INDEX IDX_E33BD3B8FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE terrain (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, localisation VARCHAR(255) NOT NULL, superficie DOUBLE PRECISION NOT NULL, prix DOUBLE PRECISION NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, latitude VARCHAR(255) DEFAULT NULL, longitude VARCHAR(255) DEFAULT NULL, INDEX IDX_C87653B1FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
