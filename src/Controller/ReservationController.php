...
class ReservationController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, Machine $id_machine): Response
    {
        ...
        // Assuming you have a way to get the current user, e.g., through security
        $user = $this->getUser();
        $reservation->setUser($user); // Associer l'utilisateur

        // Change the machine's availability to 'Non'
        $id_machine->setDisponibilite('Non');
