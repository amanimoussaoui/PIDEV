...
import Agriwise.entities.UserSession; // ✅ Correct import
...
public class Dashboard {
    ...
    void adduser(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Agriwise/views/Utilisateur/Adminadd.fxml"));
    ...
    void updateuser(ActionEvent event) {
        ...
        if (selectedUser != null) {
            try {
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Agriwise/views/Utilisateur/updateuser.fxml"));
    ...
    void redirecttomenu(ActionEvent event) {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/Agriwise/views/Utilisateur/MainmenuScene.fxml"));
