...
public class MainmenuScene {
    ...
    void logout(ActionEvent event) {
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Agriwise/views/Utilisateur/LoginScene.fxml"));
    ...
    private void redirectToProductList() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Agriwise/views/Product/product_list.fxml"));
    ...
    void redirectoprofile(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Agriwise/views/Utilisateur/ProfileScene.fxml"));
    ...
    void redirectdashboard(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Agriwise/views/Utilisateur/Dashboard.fxml"));
            Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
            stage.setScene(new Scene(root));
            stage.show();
        } catch (IOException e) {
    ...
    private void redirectToFormations() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Agriwise/views/Formation/ListFormationsFront.fxml"));
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
    ...
    private void redirectToCandidatures() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Agriwise/views/Candidature/GestionCandidature.fxml"));
            Stage stage = new Stage();
            stage.setScene(new Scene(root));
            ...
            // Fermer la fenêtre actuelle si nécessaire
            Stage currentStage = (Stage) btnCandidatures.getScene().getWindow();
            currentStage.close();
        } catch (IOException e) {
            e.printStackTrace();
        }
