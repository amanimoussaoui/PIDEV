...
public class CultureController implements Initializable {
    ...
    static double calculateProgress(Culture culture) {
        ...
        // You may want to calculate based on the elapsed time vs. duration
    ...
    private void showCultureDetails(Culture culture) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionAgricole/views/Culture/CultureDetailView.fxml"));
