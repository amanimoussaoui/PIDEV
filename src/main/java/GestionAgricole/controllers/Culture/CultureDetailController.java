package GestionAgricole.controllers.Culture;

import GestionAgricole.controllers.Recolte.RecolteDetailController;
import GestionAgricole.controllers.Recolte.RecolteFormController;
import GestionAgricole.entities.Culture;
import GestionAgricole.entities.Recolte;
import GestionAgricole.services.CultureService;
import GestionAgricole.services.RecolteService;
...
public class CultureDetailController implements Initializable {
    ...
    private void handleEdit() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionAgricole/views/Culture/CultureFormView.fxml"));
    ...
    private void handleAddRecolte() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionAgricole/views/Recolte/RecolteFormView.fxml"));
            Parent root = loader.load();
    ...
    private void handleViewRecolteDetails(Recolte recolte) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/GestionAgricole/views/Recolte/RecolteDetailView.fxml"));
            Parent root = loader.load();
