...
public class CommandeCardController {
    ...
    private Product_listController parentController;
    private Connection connect;
    private PreparedStatement prepare;

    public void setData(Commande commande, Product_listController parentController) {
        ...
        if (commande.getPaniers() != null && !commande.getPaniers().isEmpty()) {
            ...
            if (product != null) {
                ...
                if (imagePath != null && !imagePath.isEmpty()) {
                    try {
                        Image image = new Image("file:" + imagePath, 80, 80, false, true);
    ...
    private void showDetails() {
        try {
            // Charger le fichier FXML des détails de la commande
            ...
            // Passer les données de la commande et la fenêtre au contrôleur
